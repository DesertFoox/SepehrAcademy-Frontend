...
var Carousel =
  ...
  (function (_Component) {
    ...
    function Carousel() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'startTouch', function (
        e,
      ) {
            ...
            React.createElement(
              'span',
              {
                ...
                style: {
                  ...
                  width: thumbWidth,
                  top: thumbTop,
                  transform: 'rotate(-45deg) scale('.concat(
                    thumbTransform,
                    ')',
                  ),
                },
...
var Lightbox =
  ...
  (function (_React$Component) {
    ...
    function Lightbox() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'scrollZoom', function (
        e,
      ) {
        var _this$state3 = _this.state,
...
var TimePickerClock =
  ...
  (function (_Component) {
    ...
    function TimePickerClock() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onDragMove', function (
        e,
      ) {
        e.preventDefault()
        var _this$state4 = _this.state,
